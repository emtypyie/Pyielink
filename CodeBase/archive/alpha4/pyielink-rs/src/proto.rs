...
// Remote terminal channel (post-AUTH_OK, multiplexed with heartbeats).
pub const EXEC_REQ: u8 = 0x10; // C→H: [u8 flag '0'|'1'][command text] — flag '1' requests elevation
pub const EXEC_OUT: u8 = 0x11; // H→C: raw stdout/stderr bytes
pub const EXEC_END: u8 = 0x12; // H→C: exit code as ASCII decimal
pub const EXEC_DENY: u8 = 0x13; // H→C: reason string
