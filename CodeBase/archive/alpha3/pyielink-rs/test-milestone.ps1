# pyielink 0.1.0-alpha.3 milestone test (hardened protocol + roles + terminal channel)
...
function Hello($c, [string]$user) { Send-Frame $c 0x01 "$user`ntest-client-0.1.0-alpha.3" }
